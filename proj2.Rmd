...
### Synonpsis  
In this report, the aim is to analyze the impact of different weather events on public health and economy based on the storm database collected from the U.S. National Oceanic and Atmospheric Administration's (NOAA) from 1950 - 2011. The estimates of fatalities, injuries, property and crop damage to decide which types of event are most harmful to the population health and economy have been used. From these data, it is found that excessive heat and tornado are most harmful with respect to population health, while flood, drought, and hurricane/typhoon have the greatest economic consequences.
...
```{r}
setwd("C:/Users/AISHWARYA/Desktop/Data Science Coursera/5. Reproducible Research/")
...
```
If the data is already present in the directory, there is no need to download it again. It is only read.
